    ...
    def detect(self, img_path: str):
        ...
        if len(indexes) > 0:
            for i in indexes.flatten():
                ...
                cv2.putText(img, label + ' ' + confidence, (x, y + 50), self.font, 0.7, (0, 0, 255), 1)
        self.fig_image = img
...
lpd = LicensePlateDetector(
    pth_weights='data/yolov3-train_final.weights',
    pth_cfg='data/yolov3-train.cfg',
    pth_classes='data/classes.txt'
)

# Detect license plate
lpd.detect("objects-sources/img_40.jpg")
